...
class ObjectNode {
    ...
    private(set) var currentSurfaceCategory: CapturedRoom.Surface.Category?
...
struct ObjectModel: Equatable {
    ...
    var surfaceCategory: CapturedRoom.Surface.Category?

    init(dimensions: simd_float3, transform: simd_float4x4, category: CapturedRoom.Object.Category) {
        self.dimensions = dimensions
        self.transform = transform
        self.category = category
        self.surfaceCategory = nil
    }
    
    init(dimensions: simd_float3, transform: simd_float4x4, sufaceCategory: CapturedRoom.Surface.Category) {
        self.dimensions = dimensions
        self.transform = transform
        self.surfaceCategory = sufaceCategory
        self.category = nil
    }
}
